...
var _user$project$User_UserData$usernameToString = function (username) {
	return username;
};
var _user$project$User_UserData$encodeJWTAuthtoken = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$Json_Encode$string(_p1._0);
};
var _user$project$User_UserData$encode = function (user) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: A2(
			...
			_1: {
				...
				_0: A2(
					_user$project$Util_ops['=>'],
					'jwt_token',
					_user$project$User_UserData$encodeJWTAuthtoken(user.token)),
				_1: {
					ctor: '::',
					_0: A2(
						_user$project$Util_ops['=>'],
						'username',
						_elm_lang$core$Json_Encode$string(user.username)),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$User_UserData$User = F3(
	function (a, b, c) {
		return {email: a, token: b, username: c};
	});
var _user$project$User_UserData$JWTAuthToken = function (a) {
	return {ctor: 'JWTAuthToken', _0: a};
};
var _user$project$User_UserData$authTokenDecoder = A2(_elm_lang$core$Json_Decode$map, _user$project$User_UserData$JWTAuthToken, _elm_lang$core$Json_Decode$string);
var _user$project$User_UserData$decoder = A3(
	...
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'jwt_token',
		_user$project$User_UserData$authTokenDecoder,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'email',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$User_UserData$User))));
var _user$project$User_UserData$decodeUserFromJson = function (json) {
	return A2(
		_elm_lang$core$Maybe$andThen,
		function (_p2) {
			return _elm_lang$core$Result$toMaybe(
				A2(_elm_lang$core$Json_Decode$decodeString, _user$project$User_UserData$decoder, _p2));
		},
		_elm_lang$core$Result$toMaybe(
			A2(_elm_lang$core$Json_Decode$decodeValue, _elm_lang$core$Json_Decode$string, json)));
};

var _user$project$User_SessionData$withAuthorization = F2(
	function (maybeToken, builder) {
		...
		if (_p0.ctor === 'Just') {
			return A3(
				...
				'authorization',
				A2(_elm_lang$core$Basics_ops['++'], 'Bearer ', _p0._0._0),
				builder);
		} else {
			return builder;
		}
	});
var _user$project$User_SessionData$maybeAuthToken = function (session) {
	return A2(
...
var _user$project$User_SessionData$Session = function (a) {
	return {user: a};
};
...
var _user$project$Route$ShowRepository = F2(
	function (a, b) {
		return {ctor: 'ShowRepository', _0: a, _1: b};
	});
var _user$project$Route$NewRepository = {ctor: 'NewRepository'};
var _user$project$Route$Logout = {ctor: 'Logout'};
var _user$project$Route$Join = {ctor: 'Join'};
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_evancz$url_parser$UrlParser$map,
							_user$project$Route$NewRepository,
							_evancz$url_parser$UrlParser$s('repo')),
						_1: {
							ctor: '::',
							_0: A2(
								_evancz$url_parser$UrlParser$map,
								_user$project$Route$ShowRepository,
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('gitwerk'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(' is a web-based Git repository manager'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$View$navbarLink = F3(
...
var _user$project$View$viewIf = F2(
...
var _user$project$View$spinner = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('fa fa-spinner'),
		_1: {
			ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('glyphicon glyphicon-refresh'),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'}),
		_1: {
...
var _user$project$View$Join = {ctor: 'Join'};
var _user$project$View$Login = {ctor: 'Login'};
var _user$project$View$viewSignIn = F2(
	function (page, user) {
		var _p0 = user;
		if (_p0.ctor === 'Nothing') {
			return {
				ctor: '::',
				_0: A3(
					_user$project$View$navbarLink,
					_elm_lang$core$Native_Utils.eq(page, _user$project$View$Login),
					_user$project$Route$Login,
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A3(
						_user$project$View$navbarLink,
						_elm_lang$core$Native_Utils.eq(page, _user$project$View$Join),
						_user$project$Route$Join,
						{
							ctor: '::',
					...
					_user$project$Route$Home,
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'welcome ',
								_user$project$User_UserData$usernameToString(_p0._0.username))),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A3(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Create Repo'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _user$project$View$Home = {ctor: 'Home'};
var _user$project$View$viewHeader = F3(
	function (page, user, isLoading) {
		return A2(
			_elm_lang$html$Html$nav,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('navbar navbar-toggleable-md navbar-light bg-faded'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: A3(_elm_lang$html$Html_Lazy$lazy2, _user$project$View$viewIf, isLoading, _user$project$View$spinner),
									_1: {
										ctor: '::',
										_0: A3(
											_user$project$View$navbarLink,
											_elm_lang$core$Native_Utils.eq(page, _user$project$View$Home),
											_user$project$Route$Home,
											{
												ctor: '::',
										...
										_1: A2(_user$project$View$viewSignIn, page, user)
									}
								}),
							_1: {ctor: '[]'}
						}),
...
var _user$project$View$frame = F4(
	function (isLoading, user, page, content) {
		return A2(
			...
			{
				ctor: '::',
				_0: A3(_user$project$View$viewHeader, page, user, isLoading),
				_1: {
					ctor: '::',
					_0: content,
					_1: {
...
var _user$project$View$Other = {ctor: 'Other'};

var _user$project$Helpers_Page_Errored$view = F2(
...
var _user$project$Helpers_Page_Errored$Model = F2(
	function (a, b) {
		return {activePage: a, errorMessage: b};
	});
var _user$project$Helpers_Page_Errored$PageLoadError = function (a) {
	return {ctor: 'PageLoadError', _0: a};
};
var _user$project$Helpers_Page_Errored$pageLoadError = F2(
	function (activePage, errorMessage) {
		return _user$project$Helpers_Page_Errored$PageLoadError(
			{activePage: activePage, errorMessage: errorMessage});
	});

var _user$project$Helpers_Ports$storeSession = _elm_lang$core$Native_Platform.outgoingPort(
	'storeSession',
	function (v) {
		return (v.ctor === 'Nothing') ? null : v._0;
	});
var _user$project$Helpers_Ports$onSessionChange = _elm_lang$core$Native_Platform.incomingPort('onSessionChange', _elm_lang$core$Json_Decode$value);

var _user$project$Helpers_Request_ErrorsData$optionalError = function (fieldName) {
...
var _user$project$Helpers_Request_ErrorsData$httpErrorToList = F3(
	function (action, error, errorsDecoder) {
		var defaultErrorMessage = {
			ctor: '::',
			_0: A2(_elm_lang$core$Basics_ops['++'], 'unable to process ', action),
			_1: {ctor: '[]'}
		};
		var _p0 = error;
		if (_p0.ctor === 'BadStatus') {
			var _p1 = _p0._0;
			return _elm_lang$core$Native_Utils.eq(_p1.status.code, 422) ? A2(
				_elm_lang$core$Result$withDefault,
				{ctor: '[]'},
				A2(
					_elm_lang$core$Json_Decode$decodeString,
					A2(_elm_lang$core$Json_Decode$field, 'errors', errorsDecoder),
					_p1.body)) : defaultErrorMessage;
		} else {
			return defaultErrorMessage;
		}
	});

var _user$project$Helpers_Views_Form$control = F3(
...
var _user$project$Helpers_Views_Form$viewErrors = function (errors) {
	return A2(
		_elm_lang$html$Html$ul,
		{
			ctor: '::',
...
var _user$project$Helpers_Views_Form$fieldset = F2(
	function (attributes, children) {
		return A3(_user$project$Helpers_Views_Form$control, _elm_lang$html$Html$fieldset, attributes, children);
	});
var _user$project$Helpers_Views_Form$textarea = _user$project$Helpers_Views_Form$control(_elm_lang$html$Html$textarea);
var _user$project$Helpers_Views_Form$select = function (attrs) {
	return A2(
		_user$project$Helpers_Views_Form$control,
...
var _user$project$Helpers_Views_Form$radio = function (attrs) {
...
var _user$project$Helpers_Views_Form$input = function (attrs) {
	return A2(
		_user$project$Helpers_Views_Form$control,
...
var _user$project$Helpers_Views_Form$password = function (attrs) {
	return A2(
		_user$project$Helpers_Views_Form$control,
		_elm_lang$html$Html$input,
		A2(
...
var _user$project$Home_MainPage$view = F2(
	function (user, model) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
...
var _user$project$Home_MainPage$initialModel = {};
var _user$project$Home_MainPage$Model = {};
var _user$project$Home_MainPage$NoOp1 = {ctor: 'NoOp1'};
var _user$project$Home_MainPage$NoOp2 = {ctor: 'NoOp2'};
var _user$project$Home_MainPage$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {
			ctor: '_Tuple2',
			_0: {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none},
			_1: _user$project$Home_MainPage$NoOp2
		};
	});

var _user$project$User_UserRequest$storeSession = function (user) {
	return _user$project$Helpers_Ports$storeSession(
		_elm_lang$core$Maybe$Just(
			A2(
				_elm_lang$core$Json_Encode$encode,
				0,
				_user$project$User_UserData$encode(user))));
};
var _user$project$User_UserRequest$apiUrl = function (end) {
	return A2(_elm_lang$core$Basics_ops['++'], 'http://localhost:4000/api/v1/', end);
};
var _user$project$User_UserRequest$register = function (_p0) {
	var _p1 = _p0;
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						_user$project$Util_ops['=>'],
						'password',
						_elm_lang$core$Json_Encode$string(_p1.password)),
					_1: {ctor: '[]'}
				}
			}
		});
	...
	return A3(
		...
		_user$project$User_UserRequest$apiUrl('/users'),
		body,
		_user$project$User_UserData$decoder);
};
var _user$project$User_UserRequest$login = function (_p2) {
	var _p3 = _p2;
	var user = _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
	...
	return A3(
		_elm_lang$http$Http$post,
		_user$project$User_UserRequest$apiUrl('/sessions'),
		body,
		_user$project$User_UserData$decoder);
};

var _user$project$User_LoginPage$errorsDecoder = A2(
	_user$project$Helpers_Request_ErrorsData$optionalError,
	'password',
	A2(
		_user$project$Helpers_Request_ErrorsData$optionalError,
		'username',
...
var _user$project$User_LoginPage$initialModel = {
	errors: {ctor: '[]'},
	username: '',
	password: ''
};
var _user$project$User_LoginPage$Model = F3(
	function (a, b, c) {
		return {errors: a, username: b, password: c};
	});
var _user$project$User_LoginPage$Password = {ctor: 'Password'};
var _user$project$User_LoginPage$Username = {ctor: 'Username'};
var _user$project$User_LoginPage$Form = {ctor: 'Form'};
var _user$project$User_LoginPage$LoginCompleted = function (a) {
	return {ctor: 'LoginCompleted', _0: a};
};
var _user$project$User_LoginPage$SubmitForm = {ctor: 'SubmitForm'};
var _user$project$User_LoginPage$SetPassword = function (a) {
	return {ctor: 'SetPassword', _0: a};
};
var _user$project$User_LoginPage$SetUsername = function (a) {
	return {ctor: 'SetUsername', _0: a};
};
var _user$project$User_LoginPage$viewForm = A2(
	_elm_lang$html$Html$form,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onSubmit(_user$project$User_LoginPage$SubmitForm),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			_user$project$Helpers_Views_Form$input,
			{
				ctor: '::',
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$User_LoginPage$SetUsername),
						_1: {ctor: '[]'}
					}
				}
			},
		...
		_1: {
			ctor: '::',
			_0: A2(
				_user$project$Helpers_Views_Form$password,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('form-control-lg'),
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$User_LoginPage$SetPassword),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _user$project$User_LoginPage$view = F2(
								...
								_0: A2(
									...
									},
									{
										...
										_1: {
											...
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _user$project$Route$href(_user$project$Route$Join),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
											...
											_1: {
												ctor: '::',
												_0: _user$project$Helpers_Views_Form$viewErrors(model.errors),
												_1: {
													ctor: '::',
													_0: _user$project$User_LoginPage$viewForm,
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$User_LoginPage$SetUser = function (a) {
	return {ctor: 'SetUser', _0: a};
};
var _user$project$User_LoginPage$NoOp = {ctor: 'NoOp'};
var _user$project$User_LoginPage$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'SetUsername':
				return A2(
					...
					A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{username: _p0._0}),
						_elm_lang$core$Platform_Cmd$none),
					_user$project$User_LoginPage$NoOp);
			case 'SetPassword':
				return A2(
					_user$project$Util_ops['=>'],
					A2(
				...
				return A2(
					...
					A2(
						...
						A2(
							...
							_user$project$User_LoginPage$LoginCompleted,
							_user$project$User_UserRequest$login(model))),
					_user$project$User_LoginPage$NoOp);
			default:
				if (_p0._0.ctor === 'Err') {
					var errorMessages = A3(_user$project$Helpers_Request_ErrorsData$httpErrorToList, 'registration', _p0._0._0, _user$project$User_LoginPage$errorsDecoder);
					return A2(
						_user$project$Util_ops['=>'],
						A2(
							_user$project$Util_ops['=>'],
								...
								model,
								{
									errors: A2(
										...
										function (errorMessage) {
											return A2(_user$project$Util_ops['=>'], _user$project$User_LoginPage$Form, errorMessage);
										},
										errorMessages)
								}),
							_elm_lang$core$Platform_Cmd$none),
					...
					return A2(
						...
						A2(
							...
							_elm_lang$core$Platform_Cmd$batch(
								{
									ctor: '::',
									_0: _user$project$User_UserRequest$storeSession(_p1),
									_1: {
										ctor: '::',
						...
						_user$project$User_LoginPage$SetUser(_p1));
				}
		}
	});

var _user$project$User_SignupPage$errorsDecoder = A2(
	_user$project$Helpers_Request_ErrorsData$optionalError,
	'password',
	A2(
		_user$project$Helpers_Request_ErrorsData$optionalError,
...
var _user$project$User_SignupPage$initialModel = {
	errors: {ctor: '[]'},
	username: '',
	email: '',
	password: ''
};
var _user$project$User_SignupPage$Model = F4(
	function (a, b, c, d) {
		return {errors: a, username: b, email: c, password: d};
	});
var _user$project$User_SignupPage$RegisterCompleted = function (a) {
	return {ctor: 'RegisterCompleted', _0: a};
};
var _user$project$User_SignupPage$SubmitForm = {ctor: 'SubmitForm'};
var _user$project$User_SignupPage$SetUsername = function (a) {
	return {ctor: 'SetUsername', _0: a};
};
var _user$project$User_SignupPage$SetPassword = function (a) {
	return {ctor: 'SetPassword', _0: a};
};
var _user$project$User_SignupPage$SetEmail = function (a) {
	return {ctor: 'SetEmail', _0: a};
};
var _user$project$User_SignupPage$viewForm = A2(
	_elm_lang$html$Html$form,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onSubmit(_user$project$User_SignupPage$SubmitForm),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			_user$project$Helpers_Views_Form$input,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$User_SignupPage$SetUsername),
						_1: {ctor: '[]'}
					}
				}
			},
			...
			_0: A2(
				_user$project$Helpers_Views_Form$input,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$User_SignupPage$SetEmail),
							_1: {ctor: '[]'}
						}
					}
				},
				...
				_0: A2(
					_user$project$Helpers_Views_Form$password,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$User_SignupPage$SetPassword),
								_1: {ctor: '[]'}
							}
						}
					},
...
var _user$project$User_SignupPage$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
								...
								},
								{
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _user$project$User_SignupPage$viewForm,
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$User_SignupPage$Password = {ctor: 'Password'};
var _user$project$User_SignupPage$Email = {ctor: 'Email'};
var _user$project$User_SignupPage$Username = {ctor: 'Username'};
var _user$project$User_SignupPage$Form = {ctor: 'Form'};
var _user$project$User_SignupPage$SetUser = function (a) {
	return {ctor: 'SetUser', _0: a};
};
var _user$project$User_SignupPage$NoOp = {ctor: 'NoOp'};
var _user$project$User_SignupPage$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'SetEmail':
				return A2(
					...
					A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{email: _p0._0}),
						_elm_lang$core$Platform_Cmd$none),
					_user$project$User_SignupPage$NoOp);
			case 'SetUsername':
				return A2(
					_user$project$Util_ops['=>'],
					A2(
			...
			case 'SubmitForm':
				return A2(
					...
					A2(
						...
						A2(
							_elm_lang$http$Http$send,
							_user$project$User_SignupPage$RegisterCompleted,
							_user$project$User_UserRequest$register(model))),
					_user$project$User_SignupPage$NoOp);
			default:
				if (_p0._0.ctor === 'Err') {
					var errorMessages = A3(_user$project$Helpers_Request_ErrorsData$httpErrorToList, 'registration', _p0._0._0, _user$project$User_SignupPage$errorsDecoder);
					return A2(
						_user$project$Util_ops['=>'],
						A2(
							_user$project$Util_ops['=>'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									errors: A2(
										_elm_lang$core$List$map,
										function (errorMessage) {
											return A2(_user$project$Util_ops['=>'], 'Form', errorMessage);
										},
										errorMessages)
								}),
							_elm_lang$core$Platform_Cmd$none),
					...
					return A2(
						...
						_user$project$User_SignupPage$SetUser(_p1));
				}
		}
	});

var _user$project$Project_RepositoryData$Repository = F4(
	function (a, b, c, d) {
		return {id: a, name: b, namespace: c, privacy: d};
	});
var _user$project$Project_RepositoryData$decoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'privacy',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			A3(
				...
				'id',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Project_RepositoryData$Repository)))));

var _user$project$Project_RepositoryRequest$apiUrl = function (end) {
	return A2(_elm_lang$core$Basics_ops['++'], 'http://localhost:4000/api/v1/', end);
};
var _user$project$Project_RepositoryRequest$new = F2(
	function (_p0, maybeToken) {
		var _p1 = _p0;
		var expect = _elm_lang$http$Http$expectJson(_user$project$Project_RepositoryData$decoder);
		var repo = _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: A2(
					_user$project$Util_ops['=>'],
				...
				_1: {
					...
					_0: A2(
						_user$project$Util_ops['=>'],
						'privacy',
						_elm_lang$core$Json_Encode$string(_p1.privacy)),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Util_ops['=>'],
							'namespace',
							_elm_lang$core$Json_Encode$string(_p1.namespace)),
						_1: {ctor: '[]'}
					}
				}
			});
		var body = _elm_lang$http$Http$jsonBody(
			_elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: A2(_user$project$Util_ops['=>'], 'repository', repo),
					_1: {ctor: '[]'}
				}));
		return _lukewestby$elm_http_builder$HttpBuilder$toRequest(
			A3(
				...
				'application/json',
				A2(
					_user$project$User_SessionData$withAuthorization,
					maybeToken,
					A2(
						...
						A2(
							...
							_lukewestby$elm_http_builder$HttpBuilder$post(
								_user$project$Project_RepositoryRequest$apiUrl('repositories')))))));
	});
var _user$project$Project_RepositoryRequest$get = F3(
	function (namespace, name, maybeToken) {
		var expect = _elm_lang$http$Http$expectJson(_user$project$Project_RepositoryData$decoder);
		return _lukewestby$elm_http_builder$HttpBuilder$toRequest(
			A3(
				_lukewestby$elm_http_builder$HttpBuilder$withHeader,
				...
				A2(
					...
					A2(
						...
						_lukewestby$elm_http_builder$HttpBuilder$get(
							_user$project$Project_RepositoryRequest$apiUrl(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'users/',
									A2(
										_elm_lang$core$Basics_ops['++'],
										namespace,
										A2(_elm_lang$core$Basics_ops['++'], '/repositories/', name)))))))));
	});

var _user$project$Project_RepositoryPage$getSessionUsername = function (session) {
...
var _user$project$Project_RepositoryPage$errorsDecoder = A2(
	_user$project$Helpers_Request_ErrorsData$optionalError,
	'privacy',
	A2(
		_user$project$Helpers_Request_ErrorsData$optionalError,
...
var _user$project$Project_RepositoryPage$viewShow = F2(
	function (session, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('repo-first-page'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'Show Repo ', model.name)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Project_RepositoryPage$initShow = F3(
	function (namespace, repo, session) {
		var handleLoadError = function (_p1) {
			return A2(_user$project$Helpers_Page_Errored$pageLoadError, _user$project$View$Other, 'Repository is currently unavailable.');
		};
		var authToken = _user$project$User_SessionData$maybeAuthToken(session);
		return A2(
			_elm_lang$core$Task$mapError,
			handleLoadError,
			_elm_lang$http$Http$toTask(
				A3(_user$project$Project_RepositoryRequest$get, namespace, repo, authToken)));
	});
var _user$project$Project_RepositoryPage$initNew = {
	errors: {ctor: '[]'},
	name: '',
	namespace: '',
	privacy: 'private'
};
var _user$project$Project_RepositoryPage$Model = F4(
	function (a, b, c, d) {
		return {errors: a, name: b, namespace: c, privacy: d};
	});
var _user$project$Project_RepositoryPage$RepositoryCreated = function (a) {
	return {ctor: 'RepositoryCreated', _0: a};
};
var _user$project$Project_RepositoryPage$update = F3(
	function (session, msg, model) {
		...
		switch (_p2.ctor) {
			...
			case 'SubmitForm':
				var authToken = _user$project$User_SessionData$maybeAuthToken(session);
				var newModule = _elm_lang$core$Native_Utils.update(
					model,
					{
						namespace: _user$project$Project_RepositoryPage$getSessionUsername(session)
					});
				var cmdToCreateRepo = A2(
					_elm_lang$http$Http$send,
					_user$project$Project_RepositoryPage$RepositoryCreated,
					A2(_user$project$Project_RepositoryRequest$new, newModule, authToken));
				return A2(
					_user$project$Util_ops['=>'],
					_elm_lang$core$Native_Utils.update(
						newModule,
			...
			default:
				if (_p2._0.ctor === 'Err') {
					var errorMessages = A3(_user$project$Helpers_Request_ErrorsData$httpErrorToList, 'repository creation', _p2._0._0, _user$project$Project_RepositoryPage$errorsDecoder);
					return A2(
						_user$project$Util_ops['=>'],
						_elm_lang$core$Native_Utils.update(
							model,
					...
					return A2(
						...
						_elm_lang$core$Platform_Cmd$batch(
							{
								ctor: '::',
								_0: _user$project$Route$modifyUrl(
									A2(_user$project$Route$ShowRepository, _p4.namespace, _p4.name)),
								_1: {ctor: '[]'}
							}));
				}
		}
	});
var _user$project$Project_RepositoryPage$SubmitForm = {ctor: 'SubmitForm'};
var _user$project$Project_RepositoryPage$SetPrivacy = function (a) {
	return {ctor: 'SetPrivacy', _0: a};
};
var _user$project$Project_RepositoryPage$SetRepositoryName = function (a) {
	return {ctor: 'SetRepositoryName', _0: a};
};
var _user$project$Project_RepositoryPage$allowedRepoSubNameOptions = function (user) {
	return A2(
		_elm_lang$core$List$map,
		function (un) {
			return A2(
				_elm_lang$html$Html$option,
				{
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Project_RepositoryPage$SetRepositoryName(un)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(un),
					_1: {ctor: '[]'}
				});
		},
		{
...
var _user$project$Project_RepositoryPage$NoOp = {ctor: 'NoOp'};
var _user$project$Project_RepositoryPage$Private = {ctor: 'Private'};
var _user$project$Project_RepositoryPage$Public = {ctor: 'Public'};
var _user$project$Project_RepositoryPage$viewForm = function (user) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Project_RepositoryPage$SubmitForm),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_user$project$Helpers_Views_Form$select,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('form-control-lg'),
					_1: {ctor: '[]'}
				},
				_user$project$Project_RepositoryPage$allowedRepoSubNameOptions(user)),
			_1: {
				ctor: '::',
				_0: A2(
					_user$project$Helpers_Views_Form$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$placeholder('Repository name'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Project_RepositoryPage$SetRepositoryName),
								_1: {ctor: '[]'}
							}
						}
					},
				...
				_1: {
					ctor: '::',
					_0: A2(
						_user$project$Helpers_Views_Form$fieldset,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('form-control-lg'),
							_1: {ctor: '[]'}
						},
						{
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									ctor: '::',
									_0: A2(
										_user$project$Helpers_Views_Form$radio,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Project_RepositoryPage$SetPrivacy(_user$project$Project_RepositoryPage$Private)),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$name('privacyPicker'),
												_1: {
													ctor: '::',
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											_user$project$Helpers_Views_Form$radio,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Project_RepositoryPage$SetPrivacy(_user$project$Project_RepositoryPage$Public)),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$name('privacyPicker'),
													_1: {ctor: '[]'}
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Create repository'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Project_RepositoryPage$viewNewReo = F2(
	function (user, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('repo-page'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
								...
								_0: A2(
									...
									},
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _user$project$Project_RepositoryPage$viewForm(user),
												_1: {ctor: '[]'}
											}
										}
									}),
...
var _user$project$Project_RepositoryPage$view = F2(
	function (session, model) {
		var _p5 = session.user;
		if (_p5.ctor === 'Just') {
			return A2(_user$project$Project_RepositoryPage$viewNewReo, _p5._0, model);
		} else {
			return A2(
				_elm_lang$html$Html$div,
				{
...
var _user$project$Main$sessionChange = _user$project$Helpers_Ports$onSessionChange(
	function (_p0) {
		return _elm_lang$core$Result$toMaybe(
			A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$User_UserData$decoder, _p0));
	});
...
var _user$project$Main$ShowRepository = function (a) {
	return {ctor: 'ShowRepository', _0: a};
};
...
var _user$project$Main$Join = function (a) {
...
var _user$project$Main$pageErrored = F3(
	function (model, activePage, errorMessage) {
		var error = A2(_user$project$Helpers_Page_Errored$pageLoadError, activePage, errorMessage);
		return A2(
			_user$project$Util_ops['=>'],
			_elm_lang$core$Native_Utils.update(
				model,
...
var _user$project$Main$RepositoryLoaded = F3(
	function (a, b, c) {
		return {ctor: 'RepositoryLoaded', _0: a, _1: b, _2: c};
	});
				...
				case 'Home':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _user$project$Main$Loaded(
									_user$project$Main$Home(_user$project$Home_MainPage$initialModel))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Login':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _user$project$Main$Loaded(
									_user$project$Main$Login(_user$project$User_LoginPage$initialModel))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Join':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _user$project$Main$Loaded(
									_user$project$Main$Join(_user$project$User_SignupPage$initialModel))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Logout':
					...
					return A2(
						...
						_elm_lang$core$Platform_Cmd$batch(
							{
								ctor: '::',
								_0: _user$project$Helpers_Ports$storeSession(_elm_lang$core$Maybe$Nothing),
								_1: {
									ctor: '::',
				...
				case 'NewRepository':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _user$project$Main$Loaded(
									_user$project$Main$Project(_user$project$Project_RepositoryPage$initNew))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				default:
					...
					return A2(
						transition,
						A2(_user$project$Main$RepositoryLoaded, _p3, _p4),
						A3(_user$project$Project_RepositoryPage$initShow, _p3, _p4, model.session));
			}
		}
	});
	...
	function (val, location) {
		return A2(
			...
			_user$project$Route$fromLocation(location),
			{
				...
				session: {
					user: _user$project$User_UserData$decodeUserFromJson(val)
				}
			});
	});
...
var _user$project$Main$JoinMsg = function (a) {
...
var _user$project$Main$viewPage = F3(
	function (session, isLoading, page) {
		var frame = A2(_user$project$View$frame, isLoading, session.user);
		var _p5 = page;
		switch (_p5.ctor) {
			case 'NotFound':
			...
			case 'Blank':
				return A2(
					frame,
					_user$project$View$Other,
					_elm_lang$html$Html$text(''));
			case 'Errored':
				return A2(
					frame,
					_user$project$View$Other,
					A2(_user$project$Helpers_Page_Errored$view, session, _p5._0));
			case 'Login':
				return A2(
					...
					A2(
						frame,
						_user$project$View$Login,
						A2(_user$project$User_LoginPage$view, session, _p5._0)));
			case 'Join':
				return A2(
					_elm_lang$html$Html$map,
					_user$project$Main$JoinMsg,
					A2(
						frame,
						_user$project$View$Join,
						_user$project$User_SignupPage$view(_p5._0)));
			case 'Home':
				return A2(
					_elm_lang$html$Html$map,
					...
					A2(
						frame,
						_user$project$View$Home,
						A2(_user$project$Home_MainPage$view, session, _p5._0)));
			case 'Project':
				return A2(
					_elm_lang$html$Html$map,
					...
					A2(
						frame,
						_user$project$View$Home,
						A2(_user$project$Project_RepositoryPage$view, session, _p5._0)));
			default:
				return A2(
					_elm_lang$html$Html$map,
					_user$project$Main$ProjectMsg,
					A2(
						frame,
						_user$project$View$Home,
						A2(_user$project$Project_RepositoryPage$viewShow, session, _p5._0)));
		}
	});
var _user$project$Main$view = function (model) {
	var _p6 = model.pageState;
	if (_p6.ctor === 'Loaded') {
		return A3(_user$project$Main$viewPage, model.session, false, _p6._0);
	} else {
		return A3(_user$project$Main$viewPage, model.session, true, _p6._0);
	}
};
	...
	function (page, msg, model) {
		...
		do {
			switch (_p8._0.ctor) {
					...
					if (_p8._0._2.ctor === 'Ok') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									pageState: _user$project$Main$Loaded(
										_user$project$Main$ShowRepository(_p8._0._2._0))
								}),
							_elm_lang$core$Platform_Cmd$none);
					} else {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									pageState: _user$project$Main$Loaded(
										_user$project$Main$Errored(_p8._0._2._0))
								}),
							_elm_lang$core$Platform_Cmd$none);
					}
				case 'LoginMsg':
					if (_p8._1.ctor === 'Login') {
						var _p9 = A2(_user$project$User_LoginPage$update, _p8._0._0, _p8._1._0);
						var pageModel = _p9._0._0;
						var cmd = _p9._0._1;
						var msgFromPage = _p9._1;
						var newModel = function () {
							...
							if (_p10.ctor === 'NoOp') {
								...
								return _elm_lang$core$Native_Utils.update(
									...
									{
										session: {
											user: _elm_lang$core$Maybe$Just(_p10._0)
										}
									});
							}
						}();
				...
				case 'JoinMsg':
					if (_p8._1.ctor === 'Join') {
						var _p11 = A2(_user$project$User_SignupPage$update, _p8._0._0, _p8._1._0);
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								...
								{
									pageState: _user$project$Main$Loaded(
										_user$project$Main$Join(pageModel))
								}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$JoinMsg, cmd)
						};
					} else {
						break _v4_6;
					}
				case 'ProjectMsg':
					if (_p8._1.ctor === 'Project') {
						return A5(
							toPage,
							_user$project$Main$Project,
							_user$project$Main$ProjectMsg,
							_user$project$Project_RepositoryPage$update(model.session),
							_p8._0._0,
							_p8._1._0);
					} else {
						break _v4_6;
		...
		var _p13 = A2(_elm_lang$core$Debug$log, 'subModel: ', _p8._1);
		var _p14 = A2(_elm_lang$core$Debug$log, 'subMsg: ', _p8._0);
		return A2(
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"View.ActivePage":{"args":[],"tags":{"Other":[],"Home":[],"Join":[],"Login":[]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"User.UserData.JWTAuthToken":{"args":[],"tags":{"JWTAuthToken":["String"]}},"User.SignupPage.Msg":{"args":[],"tags":{"RegisterCompleted":["Result.Result Http.Error User.UserData.User"],"SetUsername":["String"],"SubmitForm":[],"SetPassword":["String"],"SetEmail":["String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Home.MainPage.Msg":{"args":[],"tags":{"NoOp1":[]}},"Route.Route":{"args":[],"tags":{"Home":[],"Logout":[],"Join":[],"NewRepository":[],"Login":[],"ShowRepository":["String","String"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Helpers.Page.Errored.PageLoadError":{"args":[],"tags":{"PageLoadError":["Helpers.Page.Errored.Model"]}},"Main.Msg":{"args":[],"tags":{"LoginMsg":["User.LoginPage.Msg"],"RepositoryLoaded":["String","String","Result.Result Helpers.Page.Errored.PageLoadError Project.RepositoryData.Repository"],"SetUser":["Maybe.Maybe User.UserData.User"],"SetRoute":["Maybe.Maybe Route.Route"],"JoinMsg":["User.SignupPage.Msg"],"HomeMsg":["Home.MainPage.Msg"],"ProjectMsg":["Project.RepositoryPage.Msg"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Project.RepositoryPage.PrivacyType":{"args":[],"tags":{"Private":[],"Public":[]}},"Project.RepositoryPage.Msg":{"args":[],"tags":{"RepositoryCreated":["Result.Result Http.Error Project.RepositoryData.Repository"],"SetPrivacy":["Project.RepositoryPage.PrivacyType"],"SetRepositoryName":["String"],"SubmitForm":[]}},"User.LoginPage.Msg":{"args":[],"tags":{"LoginCompleted":["Result.Result Http.Error User.UserData.User"],"SetUsername":["String"],"SubmitForm":[],"SetPassword":["String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Project.RepositoryData.Repository":{"args":[],"type":"{ id : String, name : String, namespace : String, privacy : String }"},"Helpers.Page.Errored.Model":{"args":[],"type":"{ activePage : View.ActivePage, errorMessage : String }"},"User.UserData.User":{"args":[],"type":"{ email : String , token : User.UserData.JWTAuthToken , username : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
